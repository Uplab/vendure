...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/service/services/administrator.service.ts" sourceLine="52" packageName="@vendure/core" />
