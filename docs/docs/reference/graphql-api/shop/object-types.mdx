...
>
{`union AddPaymentToOrderResult = Order | OrderPaymentStateError | IneligiblePaymentMethodError | PaymentFailedError | PaymentDeclinedError | OrderStateTransitionError | NoActiveOrderError | CouponRemovedDuringCheckoutError`}
</GraphQLDoc>
...
<GraphQLDoc
  ...
  typeLinks={{
    ...
    AssetVisibility: '/reference/graphql-api/shop/enums#assetvisibility',
