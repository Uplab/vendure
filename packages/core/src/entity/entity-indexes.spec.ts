...
describe('entity index metadata', () => {
    ...
    // embed that both of these have) the rebuild produces a new array, so the automatic index is
    // silently discarded. An explicit @Index is stored in ownIndices and therefore survives.
